...
import { NestedEnumPermissionLevelWithAggregatesFilter } from './nested-enum-permission-level-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumPermissionLevelFilter } from './nested-enum-permission-level-filter.input';

@InputType()
export class EnumPermissionLevelWithAggregatesFilter {
